 ...
 * generated in the com.accenture.flowershop.fe.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _IncreaseFlowersStockSizeResponse_QNAME = new QName("http://ws.fe.flowershop.accenture.com/", "increaseFlowersStockSizeResponse");
    private final static QName _IncreaseFlowersStockSize_QNAME = new QName("http://ws.fe.flowershop.accenture.com/", "increaseFlowersStockSize");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.accenture.flowershop.fe.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.fe.flowershop.accenture.com/", name = "increaseFlowersStockSizeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.fe.flowershop.accenture.com/", name = "increaseFlowersStockSize")
